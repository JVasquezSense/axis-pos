...

{
  ...
  "ingredients": [{"name": "<nombre>", "unit": "<kg|L|und — SIEMPRE la unidad de COMPRA, nunca g ni ml>", "quantity": <numero decimal en esa unidad: 200 g se escribe 0.2 con unit kg; 30 ml se escribe 0.03 con unit L>, "waste": <merma tipica decimal: carnes 0.10-0.15, vegetales 0.15-0.25, frutas 0.10-0.20, mariscos 0.15-0.20, pollo 0.08-0.12, otros 0.05-0.10>, "existingId": "<id o null>", "cost": <costo unitario COP por unidad del campo unit, ej: 5000 por kg de carne>}]
}
