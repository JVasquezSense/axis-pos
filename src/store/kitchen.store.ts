...
interface KitchenState {
  tickets: KdsTicket[];
  seq: number;
  /** Crea un ticket de cocina a partir de las líneas de un pedido del POS. */
  addFromOrder: (lines: OrderLine[], table: number | null, channel: OrderChannel) => KdsTicket;
  /** Crea un ticket a partir de un pedido web verificado. */
...
export const useKitchenStore = create<KitchenState>()(
  persist(
    (set, get) => ({
      tickets: structuredClone(KDS_TICKETS),
      seq: 1100,
